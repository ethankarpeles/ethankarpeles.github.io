        ...
        <>
            <article>
                ...
                <section>
                    ...
                    <p>
                        To ensure the generality of the Jacobian conjecture is
                        fully appreciated, I would like to start off with a few
                        definitions from Dummit and Foote's Abstract Algebra.
                    </p>
                    ...
                    <p>
                        ...
                        <Latex math="*" /> on a set <Latex math="G" /> is a
                        function <Latex math="* \colon G \times G \to G" />. For
                        any <Latex math="a, b \in G" />, we write{" "}
                        <Latex math="a * b" /> for <Latex math="*(a, b)" />.
                    </p>
                    ...
                    <p>
                        ...
                        is a set <Latex math="G" /> equipped with a binary
                ...
                \end{alignedat}"
                    ...
                    <p>
                        ...
                        of <Latex math="G" />, and <Latex math="a^{-1}" /> in
                        the third property is called the{" "}
                        <u>
                            <a
                    ...
                    <Latex
                        math="\forall a, b \in G \quad a * b = b * a"
                        center
                    />
                    ...
                    <p>
                        ...
                        <Latex math="+" /> and <Latex math="\times" /> (called
                        addition and multiplication respectively) satisfying the
                        following properties:
                    </p>
                    <ul>
                        <li>
                            <Latex math="F" /> is a commutative group with
                            respect to <Latex math="+" />. We will call the
                            identity of this group <Latex math="0" />.
                        </li>
                        <li>
                            <Latex math="F \setminus \{0\}" /> is a commutative
                            group with respect to <Latex math="\times" />. We
                            will call the identity of this group{" "}
                            <Latex math="1" />.
                        </li>
                        <li>
                    ...
                    <Latex
                        math="(a + b) \times c = (a \times c) + (b \times c)"
                        center
                    />
                    ...
                    <p>
                        Real numbers, complex numbers, and rational numbers are
                    ...
                    <p>
                        ...
                        <Latex math="\text{char}(F) = 0" />. For the remainder
                        of this article, we will restrict our attention to
                        fields of characteristic zero for the sake of
                        simplicity.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        <Latex math="n" /> polynomials each in{" "}
                        <Latex math="n" /> variables with coefficients in a
                        field <Latex math="\mathbb{K}" />:
                    </p>
                    ...
                    <p>
                        Here are some examples of what one of these{" "}
                        <Latex math="f_i" /> could look like for clarity (in the{" "}
                    ...
                    <p>
                        ...
                        <Latex math="\mathbb{K}[x_1, \dots, x_n]" /> and induces
                        a function:
                    </p>
                    <Latex
                        math="f_i \colon \mathbb{K}^n \to \mathbb{K}"
                        center
                    />

                    <p>
                        We can combine these induced functions to create a
                        polynomial map{" "}
                        <Latex math="F \colon \mathbb{K}^n \to \mathbb{K}^n" />{" "}
                ...
                \end{align*}"
                    ...
                    <p>
                        The Jacobian conjecture involves functions of this form.
                    </p>

                    <p>
                        For one of the polynomials <Latex math="f_i" />, we can
                        define the{" "}
                        <u>
                            <a
                        ...
                        <Latex math="x_j" /> as a purely algebraic object as
                        follows. For each term of the polynomial, we do the
                        following:
                    </p>
                    <ul style={{ width: "100%" }}>
                        <li>
                            If the term does not have a factor of{" "}
                            <Latex math="x_j" />, it contributes zero to the
                            partial derivative.
                        </li>
                        <li style={{ width: "100%" }}>
                            ...
                            <p>
                                ...
                                , and <Latex math="k_j \ge 1" />. This term
                                contributes the following to the partial
                                derivative:
                            </p>
                            <Latex
                    ...
                    <p>
                        The partial derivative of <Latex math="f_i" /> is the
                        sum of these contributions. Notice a key point: we never
                        in our discussion of these partial derivatives needed to
                        invoke calculus, the slope of a tangent line, or
                        anything of this nature! We write the partial derivative
                        of <Latex math="f_i" /> with respect to{" "}
                        <Latex math="x_j" /> as{" "}
                        <Latex math="\frac{\partial f_i}{\partial x_j}" />.
                    </p>

                    <p>
                        We can then form a matrix with all possible partial
                ...
                \end{bmatrix}"
                    ...
                    <p>
                        We call this matrix the Jacobian matrix of{" "}
                        <Latex math="F" />. The determinant of this matrix is
                ...
                <section>
                    ...
                    <p>
                        Before stating the actual conjecture, I would like to
                        show the following:
                    </p>

                    <p style={{ textAlign: "center" }}>
                        If <Latex math="F" /> has a polynomial inverse function{" "}
                        <Latex math="G \colon \mathbb{K}^n \to \mathbb{K}^n" />,
                        then <Latex math="J_F" /> is a nonzero constant in{" "}
                        <Latex math="\mathbb{K}" />.
                    </p>
                ...
                \end{align*}"
                    ...
                    <p>
                        However{" "}
                        <Latex math="G(F(\vec{x})) = \text{id}(\vec{x})" /> so,
                    </p>
                    <Latex
                        math="\begin{align*}
                ...
                \end{align*}"
                    ...
                    <p>
                        ...
                        <Latex math="J_F \mathrel{\rlap{/}{=}} 0" /> because 0
                        has no inverse under multiplication. Furthermore,{" "}
                        <Latex math="J_F" /> and{" "}
                        <Latex math="\text{det}(DG(F(\vec{x})))" /> are nonzero
                    ...
                    <p style={{ textAlign: "center" }}>
                        Let <Latex math="\mathbb{K}" /> be a field of
                        characteristic zero. If <Latex math="J_F" /> is a
                        nonzero constant, then <Latex math="F" /> has an inverse
                        function{" "}
                        <Latex math="G \colon \mathbb{K}^n \to \mathbb{K}^n" />{" "}
                        with components as polynomials.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        therefore cannot have a polynomial inverse. It is given
                        by:
                    </p>
                    <Latex
                        math="\begin{align*}
                ...
                \end{align*}"
                    ...
                    <p>
                        ...
                        <Latex math="J_F = -2" />. The computation can be
                        checked with{" "}
                        <u>
                            <a
                    ...
                    <p>
                        The reason this function is not injective is because we
                        have three points in the domain of <Latex math="F" />{" "}
                ...
                \end{align*}"
                    ...
                    <p>
                        This particular counterexample in <Latex math="n=3" />{" "}
                        can be used to generate counterexamples to the
                        conjecture for all <Latex math="n > 2" />. The{" "}
                        <Latex math="n=2" /> case remains open.
                    </p>

                    <p>
                        For a deeper geometric explanation, I highly recommend
                        reading{" "}
                        <u>
                            <a
                        ...
                        on this topic. He talks about the result at a much more
                        general level, and it was an incredibly interesting
                        read.
                    </p>
                </section>
            </article>
